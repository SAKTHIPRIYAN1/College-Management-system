...
const EventTable=({admin})=>{
    ...
    useEffect(() => {
        const fetchEventRequests = async () => {
            try {
                const response = await axios.get(SERVER_URL+`/admin/eventrequests`);
                // console.log('hii')
...
const handleApprove = async (index) => {
    ...
    const date = getTodayDate();
        ...
        try {
            let resp='Approved';
            console.log(adminid)
            const response = await axios.patch(SERVER_URL+'/admin/eventrequests/approve', {...event,date,adminid,resp});
    ...
    const handleReject =async(argu)=>{
        ...
        try {
           let resp='Rejected';
            const response = await axios.patch(SERVER_URL+'/admin/eventrequests/reject', {...event,date,adminid,resp});
