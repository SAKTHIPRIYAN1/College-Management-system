...
const AdminChangePass=()=>{
    ...
    let regno=alum && alum.regno?alum.regno:' ';
    // console.log(adminId);
    ...
    const handlesub=async(e)=>{
        ...
        if(data2.confrm_password!==data2.newpassword){
            ...
            if(passkey.length<8){
                ...
                try{
                let response= await axios.patch('http://localhost:3000/alumini/changepassword',data2)
                seterrmsg('');
                e.target.reset();
